...
namespace Player.IO_Client_Example {
	class Program {
		static void Main(string[] args) {
			...
			var client = PlayerIO.Connect(
                "mp-tanks-2d-8k3ooylhkcmhf2kerl3sg",	// Game id (Get your own at gamesnet.yahoo.com. 1: Create user, 2:Goto control panel, 3:Create game, 4: Copy game id inside the "")
			...
			var connection = client.Multiplayer.CreateJoinRoom("my-room-id", "default", true, null, null);
    ...
    public struct c
    {
        ...
        string fc;
        [FieldOffset(sizeof(int) + IntPtr.Size)]
        string d;
    }
}