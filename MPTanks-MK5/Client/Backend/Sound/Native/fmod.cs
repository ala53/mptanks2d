...
namespace FMOD
{
    ...
    */
    ...
    public struct VECTOR
    {
        ...
        public static implicit operator Microsoft.Xna.Framework.Vector2(VECTOR me)
        {
            return new Microsoft.Xna.Framework.Vector2(me.x, me.y);
        }
        public static implicit operator VECTOR(Microsoft.Xna.Framework.Vector2 me)
        {
            return new VECTOR { x = me.X, y = me.Y };
        }
        public static implicit operator Microsoft.Xna.Framework.Vector3(VECTOR me)
        {
            return new Microsoft.Xna.Framework.Vector3(me.x, me.y, me.z);
        }
        public static implicit operator VECTOR(Microsoft.Xna.Framework.Vector3 me)
        {
            return new VECTOR { x = me.X, y = me.Y, z = me.Z };
        }
    }
